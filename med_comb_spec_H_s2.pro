...
wavestandard=readfits('wave00H.fits') ; arbitrarily use the first wave file as the standard
...
for i=1,looper-2 do begin ; for each wavelength in the standard file except the first and last
   ...
   for k=0,srv(1)-1 do begin ; look through each epoch's spectrum
      ...
      wavefile='wave'+dfn+'H.fits'
      specfile='spec'+dfn+'H.fits'
...
writefits,'waveo_H.fits',waveo,hdr
writefits,'speco_H.fits',speco,hdr
writefits,'unco_H.fits',unco,hdr
